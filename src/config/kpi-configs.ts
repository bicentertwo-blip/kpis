...
// campoMetaNumero disponible para uso futuro
const _campoMetaNumero: FieldDefinition = {
  id: 'meta',
  label: 'Meta',
  type: 'number',
  placeholder: '100',
...
export { _campoMetaNumero as campoMetaNumero }
...
export const ROE_ROA_CONFIG: KpiDefinition = {
  ...
  name: 'ROE y ROA',
  shortName: 'ROE/ROA',
  description: 'Evalúa el rendimiento sobre capital contable y activos (operativo y neto).',
  icon: 'GaugeCircle',
  ...
  summaries: [
    {
      ...
      description: 'Indicadores de rentabilidad operativa y neta sobre capital y activos',
      ...
      fields: [
        ...
        // ROE/ROA Operativo
        {
          ...
          type: 'percentage',
          placeholder: '18.5',
          description: 'Utilidad Operativa / Capital Contable',
          required: true,
        },
        {
          id: 'roa_operativo',
          ...
          type: 'percentage',
          placeholder: '2.8',
          description: 'Utilidad Operativa / Activo Total',
          required: true,
        },
        // ROE/ROA Neto
        {
        ...
        // Metas mensuales
        {
          id: 'meta_roe_operativo',
          label: 'Meta ROE Operativo (%)',
          type: 'percentage',
          placeholder: '20',
          required: true,
        },
        {
          id: 'meta_roa_operativo',
          label: 'Meta ROA Operativo (%)',
          type: 'percentage',
          placeholder: '3',
          required: true,
        },
        ...
        // Metas anuales (opcionales)
        {
          id: 'meta_anual_roe_operativo',
          label: 'Meta Anual ROE Operativo (%)',
          type: 'percentage',
          placeholder: '22',
          description: 'Meta anual de ROE Operativo',
          required: false,
        },
        {
          id: 'meta_anual_roe_neto',
          label: 'Meta Anual ROE Neto (%)',
          type: 'percentage',
          placeholder: '19',
          description: 'Meta anual de ROE Neto',
          required: false,
        },
        {
          id: 'meta_anual_roa_operativo',
          label: 'Meta Anual ROA Operativo (%)',
          type: 'percentage',
          placeholder: '3.5',
          description: 'Meta anual de ROA Operativo',
          required: false,
        },
        {
          id: 'meta_anual_roa_neto',
          label: 'Meta Anual ROA Neto (%)',
          type: 'percentage',
          placeholder: '3',
          description: 'Meta anual de ROA Neto',
          required: false,
        },
      ],
    },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'currency',
          placeholder: '2,000',
          description: 'Meta de gasto por crédito',
          required: true,
        },
        campoMetaAnual,
      ],
  ...
  summaries: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'percentage',
          placeholder: '3.5',
          description: 'Meta de rotación mensual',
          required: true,
        },
        {
          id: 'meta_anual',
          ...
          type: 'percentage',
          placeholder: '35',
          description: 'Meta anual de rotación',
          required: false,
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'number',
          placeholder: '10',
          description: 'Meta de días para cubrir',
          required: true,
        },
        {
          id: 'meta_anual',
          ...
          type: 'number',
          placeholder: '10',
          description: 'Meta anual de días',
          required: false,
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'percentage',
          placeholder: '2',
          description: 'Meta de ausentismo',
          required: true,
        },
        {
          id: 'meta_anual',
          ...
          type: 'percentage',
          placeholder: '2',
          description: 'Meta anual de ausentismo',
          required: false,
        },
      ],
    },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'number',
          placeholder: '0',
          description: 'Meta de observaciones (ideal 0)',
          required: true,
        },
        {
          id: 'meta_anual',
          ...
          type: 'number',
          placeholder: '0',
          description: 'Meta anual de observaciones',
          required: false,
        },
      ],
    },
  ...
  summaries: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'percentage',
          placeholder: '100',
          description: 'Meta de acuerdos cumplidos',
          required: true,
        },
        {
